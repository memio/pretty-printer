...
# Docker containers
LIB_SERVICE = memio-pretty-printer
...
cs-fix: ## Fixes CS with Swiss Knife and PHP-CS-Fixer
	@$(SWISS_KNIFE) namespace-to-psr-4 spec/Memio/PrettyPrinter --namespace-root 'spec\\Memio\\PrettyPrinter\\'
	@$(SWISS_KNIFE) namespace-to-psr-4 src/Memio/PrettyPrinter --namespace-root 'Memio\\PrettyPrinter\\'
